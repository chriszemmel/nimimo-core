...
That's the system I designed on paper first. **The four-axes and sixteen-states formalism was written on December 18, 2025 and circulated to peers on Telegram in the days that followed — before this repo existed.** Months of implementation followed, against that spec. The code in this repo is the working-out of the papers, not a post-hoc story told over a finished codebase.
