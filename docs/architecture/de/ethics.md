...
die Non-Features, auf die nimimo verzichtet, keine
...
Flows. Die meisten Punkte, die nimimo bewusst nicht baut,
Fiat-On/Off-Ramps, verwahrende Wiederherstellungspfade, KYC-Onboarding, auch
...
Die Liste der Non-Features ist keine
...
[`regulatory-posture.md`](./regulatory-posture.md) und
